...
import medvoll.spring3_alura.domain.paciente.DadosCadastroPaciente;
...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Devolver null quando único médico cadastrado nao esta disponível na data")
    ...
    @Test
    @DisplayName("Devolver médico cadastrado quando ele estiver disponível na data")
    void escolherMedicoAleatorioLivreNaDataCenario2() {
        ...
        assertThat(medicoLivre.stream().findFirst()).isEqualTo(Optional.of(medico));
